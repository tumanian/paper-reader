...
const APP_MODULES = ['js/util.js', 'js/state.js', 'js/api.js', 'js/persistence.js', 'js/library.js', 'js/pdf.js', 'js/citation-parse.js', 'js/sanitize.js', 'js/analytics.js', 'js/equation-highlight.js', 'js/web-loader.js', 'js/citation-resolve.js', 'js/selection.js', 'js/figure.js', 'js/chat.js', 'js/onboarding.js', 'js/touch-notice.js', 'js/main.js'];
...
;globalThis.__PR__ = (function () {
  ...
  return {
    fns: {
      ...
      isPlausibleAuthorPart, parseAuthorYearFromSelection, parsePartialAuthorYearFromSelection,
      authorMatchRequirements, yearMatchesRef,
      authorTokenInRef, scoreRefForAuthorYear, findBestAuthorYearMatch, findBestAuthorYearMatchByPrefix, refMatchesAuthorYear, authorLastNames,
