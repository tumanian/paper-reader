...
const APP_MODULES = ['js/util.js', 'js/state.js', 'js/persistence.js', 'js/library.js', 'js/pdf.js', 'js/citation-parse.js', 'js/web-loader.js', 'js/citation-resolve.js', 'js/selection.js', 'js/main.js'];
