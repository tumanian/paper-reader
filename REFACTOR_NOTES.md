...
> Branch: `modularization`. Last updated: Phase 3 citation-resolve DONE (js/citation-resolve.js extracted, 119 green). Next: Step 9 selection.js (+math).
>
...
- Phase 3:
  ...
  - **NEXT → Step 9:** extract `js/selection.js` (+math): text-selection popover (positionPopover, hidePopover, updatePopoverButtons, classifySelection), math buttons/discussion (updateMathButtons, startMathDiscussion), selection→discussion creation, updateReturnButton, finishCitationNavigation, openCitationPaper, addSelectionToReadLater, normalizePdfSelectionText usage. Run suite + ESM guard, commit.
