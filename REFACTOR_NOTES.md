...
> Branch: `modularization`. Last updated: Phase 3 Step 4 DONE (js/library.js extracted, 119 green). Next: Step 5 extract js/pdf.js.
>
...
- Phase 3:
  ...
  - **NEXT → Step 5:** extract `js/pdf.js` (`loadPDF`, `renderFromBuffer`, PDF text utils, `renderPDFPages`, `restoreHighlightsForLoadedPages`, drop-zone/file-input wiring). Run suite + ESM guard, commit.
